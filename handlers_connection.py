...
async def connect_airbase(ctx, params: ConnectParams) -> ActionResult[ConnectionRecord]:
...
async def disconnect_airbase(ctx, params: ConnectionIdParams) -> ActionResult[DeleteResult]:
