# Plausible Scenario Tests (PST) — Airbase Connector
...
- `connect_airbase`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_airbase`: validated contract & error handling
- `list_expenses`: validated contract & error handling
- `get_expense`: validated contract & error handling
- `create_expense`: validated contract & error handling
- `update_expense`: validated contract & error handling
- `delete_expense`: validated contract & error handling
